 ...
 * @author ep
 */
public class FltBondBean implements IFndtModel, ITrendable {
    ...
    public FltBondBean(InstrumentQuote iQuote) {
        this.iQuote = iQuote;
    }
    ...
    public Object getValueAt(int columnIndex) {
        return switch (columnIndex) {
            case 0 -> {
                String code = "";
                if (iQuote.getMasterData() instanceof FltSecurityMasterData bfmd) {
