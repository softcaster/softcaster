 ...
 * @author ep
 */
public class BondFutBean implements IFndtModel, ITrendable {
    ...
    public BondFutBean(InstrumentQuote iQuote) {
        this.iQuote = iQuote;
    }
    ...
    public Object getValueAt(int columnIndex) {
        return switch (columnIndex) {
            case 0 ->{
                String code = "";
                if(iQuote.getMasterData() instanceof BondFutureMasterData bfmd) {
    ...
    public String[] getColumnNames() {
        return new String[]{"Isin", "Code", "Bid", "Ask"};
    }
