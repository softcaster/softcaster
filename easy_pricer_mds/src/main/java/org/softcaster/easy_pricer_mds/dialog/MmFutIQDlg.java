 ...
 * @author ep
 */
public class MmFutIQDlg extends javax.swing.JDialog {

    private final MDSFacade mDSFacade;
    private MmFutBean bean;
     ...
     * @param mDSFacade
     */
    public MmFutIQDlg(java.awt.Frame parent, boolean modal, MmFutBean bean, MDSFacade mDSFacade) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        cbMmFut = new javax.swing.JComboBox<>();
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        detailPanel.add(cbMmFut, gridBagConstraints);
    ...
    private javax.swing.JComboBox<MmFutureMasterData> cbMmFut;
    ...
    private void postInit() {
        ...
        if (bean != null) {
            ...
            cbMmFut.setSelectedItem(bean.getInstrumentQuote().getMasterData());
    ...
    private void setUpCurrencyPairsCombo() {
        List<MmFutureMasterData> mfmdList = mDSFacade.getMmFutureMasterDataDAO().findAll();

        // 2. Crea il modello partendo dalla lista
        DefaultComboBoxModel<MmFutureMasterData> model = new DefaultComboBoxModel<>(mfmdList.toArray(MmFutureMasterData[]::new));
        cbMmFut.setModel(model);
    ...
    private boolean saveBean() {
        try {
            if (isInsert) {
                bean = new MmFutBean(new InstrumentQuote());
            }
            InstrumentQuote iq = bean.getInstrumentQuote();
            iq.setMasterData((MasterData) cbMmFut.getSelectedItem());
