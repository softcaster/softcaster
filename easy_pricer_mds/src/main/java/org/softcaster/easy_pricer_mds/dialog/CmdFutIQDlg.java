 ...
 * @author ep
 */
public class CmdFutIQDlg extends javax.swing.JDialog {

    private final MDSFacade mDSFacade;
    private CmdFutBean bean;
     ...
     * @param mDSFacade
     */
    public CmdFutIQDlg(java.awt.Frame parent, boolean modal, CmdFutBean bean, MDSFacade mDSFacade) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        cbCmdFut = new javax.swing.JComboBox<>();
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        detailPanel.add(cbCmdFut, gridBagConstraints);
        ...
        cbProvider.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CmeGroupProvider", "EexProvider", "EuroNextProvider", "InvestingComProvider" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
    ...
    private javax.swing.JComboBox<CmdFutureMasterData> cbCmdFut;
    ...
    private void postInit() {
        setUpCurrencyPairsCombo();

        if (bean != null) {
            isInsert = false;
            txtCode.setText(bean.getInstrumentQuote().getCode());
            cbCmdFut.setSelectedItem(bean.getInstrumentQuote().getMasterData());
    ...
    private void setUpCurrencyPairsCombo() {
        List<CmdFutureMasterData> cfmdList = mDSFacade.getCmdFutureMasterDataDAO().findAll();

        // 2. Crea il modello partendo dalla lista
        DefaultComboBoxModel<CmdFutureMasterData> model = new DefaultComboBoxModel<>(cfmdList.toArray(CmdFutureMasterData[]::new));
        cbCmdFut.setModel(model);
    ...
    private boolean saveBean() {
        try {
            if (isInsert) {
                bean = new CmdFutBean(new InstrumentQuote());
            }
            InstrumentQuote iq = bean.getInstrumentQuote();
            iq.setMasterData((MasterData) cbCmdFut.getSelectedItem());
