 ...
 * @author ep
 */
public class FltBondIQDlg extends javax.swing.JDialog {
     ...
     * @param mDSFacade
     */
    public FltBondIQDlg(java.awt.Frame parent, boolean modal, FltBondBean bean, MDSFacade mDSFacade) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        cbProvider.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CmeGroupProvider", "EuroNextProvider", "BorsaItalianaProvider" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
    ...
    private javax.swing.JComboBox<FltSecurityMasterData> cbBond;
    ...
    private void setUpBondsCombo() {
        List<FltSecurityMasterData> bondList = mDSFacade.getFltSecurityMasterDataDAO().findAll();

        // 2. Crea il modello partendo dalla lista
        DefaultComboBoxModel<FltSecurityMasterData> model = new DefaultComboBoxModel<>(bondList.toArray(FltSecurityMasterData[]::new));
    ...
    private boolean saveBean() {
        try {
            if (isInsert) {
                bean = new FltBondBean(new InstrumentQuote());
            }
