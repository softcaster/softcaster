...
import type {
    FinancialTxnDto,GenericMasterDataDto
} from '../services/dto';
...
export function useFinancialViewDto<TMasterDto>(
    assetClass: string,
    ...
    const [masterDataList, setMasterDataList] = useState<TMasterDto[]>([]);
