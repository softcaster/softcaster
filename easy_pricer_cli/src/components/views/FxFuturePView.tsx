...
import { fetchFxFutureMasterDataByAssetClass, fetchYieldCurveDto } from '../services/services';
...
const FxFuturePView = () => (
    <GenericPricingView2 <FxFutureMasterData, ForwardPricingRequest, ForwardPricingResponse>
        fetchMasterData={fetchFxFutureMasterDataByAssetClass}
