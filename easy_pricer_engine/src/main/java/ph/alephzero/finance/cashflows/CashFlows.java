...
/**
 * Cash flows represent a time series of monetary amounts that are either inflow
 * or outflow...
 *
...
public interface CashFlows {
    ...
    /**
     * Returns the base/reference date. For dated cash flows, index 0
     * corresponds to this base date
     *
     * @return base date
     */
    Date getBaseDate();
    ...
    /**
     * *
     * Returns the number of distinct time points with cash flows. For
     * perpetuities, this is -1.
     *
    ...
    /**
     * *
     * Returns true if cash flows can be assumed to occur in regular intervals
     * (i.e. equally spaced). This should be true if <code>isDated()</code> is
     * false.
     *
    ...
    /**
     * *
     * Returns true if each cash flow has an associated date, false if
     * integer-indexed only.
     *
    ...
    /**
     * *
     * Returns a SortedMap<Date, Double> version of this set of cash flows. This
     * will throw an exception if isDated() is false.
     *
