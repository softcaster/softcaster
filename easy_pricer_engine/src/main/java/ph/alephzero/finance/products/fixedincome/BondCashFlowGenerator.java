...
public final class BondCashFlowGenerator {
    ...
    /**
     * @return cash flow schedule for zero-coupon securities (discounted, add-on bonds).Cash flow is only on maturity.Cash flow
     * @ipc:calculation
     * @param maturity
     * @
     */
    ...
    /**
     * Returns cash flow schedule for RPI bonds starting right after settlement date.I.e. 
     * first cash flow is for the first interest payment <i>after</i> the settlement date.
