...
public class CashFlowCalculatorTest {
    ...
    public void testPresentValueExcelExample() {
        ...
        assertEquals(CashFlowCalculator.presentValue(cf, 0.08 / 12, Compounding.COMPOUNDED), 59777.145851, 0.000001);

        cf = BasicCashFlows.buildCashFlows(12 * 20, 0.0, 500.0, 0.0, false);
        assertEquals(CashFlowCalculator.presentValue(cf, 0.08 / 12, Compounding.COMPOUNDED), 60175.660157, 0.000001);
    }
