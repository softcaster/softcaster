 ...
 * @author softc
 */
public class UsaYcImportMgr implements IImportMgr {

    private static UsaYcImportMgr _instance = null;
    ...
    public void start(IProgressInfo progressInfo) {
        ...
        try {
            ...
            YieldCurveImportMgr.saveNodes(rates,"USAYC",yieldCurveDAO);
    ...
    public static UsaYcImportMgr getInstance(YieldCurveDAO dao) {
        if (_instance == null) {
            _instance = new UsaYcImportMgr();
            yieldCurveDAO = dao;
        }
        return _instance;
    }
