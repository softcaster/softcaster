...
@Service
public class CouponAccountingEventService extends BaseAccountingEventService {

    private static final Logger log = LoggerFactory.getLogger(CouponAccountingEventService.class);
