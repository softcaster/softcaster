 ...
 * @author softc
 */
public class PortfolioPanel extends AbstactMDPanel {
     ...
     */
    public PortfolioPanel(MasterDataFacade masterDataFacade) {
        this.masterDataFacade = masterDataFacade;
        initComponents();
        postInitComponents(portfolioTable);
    }
    ...
    private void initComponents() {
        ...
        lblHeader.setText("Portfolios Master Data");
    ...
    protected void fillModelList() {
        ...
        PortfolioBean prototype = new PortfolioBean(null);
        MasterDataTableModel<PortfolioBean> model = new MasterDataTableModel<>(prototype);
    ...
    protected void acNewActionPerformed(ActionEvent evt) {
        ...
        MasterDataTableModel<PortfolioBean> model = (MasterDataTableModel<PortfolioBean>) portfolioTable.getModel();
        refreshModel(model);
    }
    ...
    protected void acModActionPerformed(ActionEvent evt) {
        ...
        if (rowIndex != -1) {
            ...
            int modelRow = portfolioTable.convertRowIndexToModel(rowIndex);
            MasterDataTableModel<PortfolioBean> model = (MasterDataTableModel<PortfolioBean>) portfolioTable.getModel();
    ...
    protected void refreshModel(MasterDataTableModel model) {
        ...
        List<PortfolioBean> portfolioBeanList = new ArrayList<>();
        PortfolioBean bean = null;
        for (PortfolioMasterData item : portfolios) {
            bean = new PortfolioBean(item);
            portfolioBeanList.add(bean);
        }
        model.setData(portfolioBeanList);
    }
