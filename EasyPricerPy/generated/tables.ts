...
export interface MasterData {
    ...
    issueDate: Date;
    maturityDate: Date;
    typeOfInterest: Type_of_interest;
    form: Form;
    daycount: Daycount;
    frequency: Frequency;
    rollConvention: Roll_convention;
    accrualScheduleType: Accrual_schedule_type;
    interestRate: number;
    issuePrice: number;
...
export interface CashFlowItem {
    ...
    masterData: Bond_future_master_data;
    startDate: Date;
    endDate: Date;
    interest: number;
    amount: number;
...
// ForexMasterData
//----------------------------------------------------------------------
export interface ForexMasterData {
    idMasterData: number;
    bcy: Currency;
    ccy: Currency;
    bcyIrc: string;
...
export interface PositionMasterData {
    ...
    code: string;
    description: string;
    portfolio: Portfolio_master_data;
}
...
export interface PositionDetail {
    ...
    positionMd: Position_master_data;
    masterData: Bond_future_master_data;
    realizedPnl: number;
