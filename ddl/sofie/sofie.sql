...
ALTER SEQUENCE daycount_s OWNER TO sofie;
...
ALTER SEQUENCE frequency_s OWNER TO sofie;
...
ALTER SEQUENCE form_s OWNER TO sofie;
...
ALTER SEQUENCE roll_convention_s OWNER TO sofie;
...
ALTER SEQUENCE type_of_interest_s OWNER TO sofie;
...
ALTER SEQUENCE accrual_schedule_type_s OWNER TO sofie;
...
ALTER SEQUENCE amortization_schedule_s OWNER TO sofie;
...
-- Creo sequenza
CREATE SEQUENCE compounding_s START WITH 1 INCREMENT BY 1; 
ALTER SEQUENCE compounding_s OWNER TO sofie;
...
ALTER SEQUENCE calendar_s OWNER TO sofie;
...
ALTER SEQUENCE holiday_s OWNER TO sofie;
...
ALTER SEQUENCE super_class_s OWNER TO sofie;
...
ALTER SEQUENCE asset_class_s OWNER TO sofie;
...
ALTER SEQUENCE master_data_s OWNER TO sofie;
...
ALTER SEQUENCE cash_flow_item_s OWNER TO sofie;
...
ALTER SEQUENCE cash_flow_reset_s OWNER TO sofie;
...
ALTER SEQUENCE yield_curve_s OWNER TO sofie;
...
ALTER SEQUENCE settlement_type_s OWNER TO sofie;
...
ALTER SEQUENCE deliverable_bonds_s OWNER TO sofie;
...
ALTER SEQUENCE instrument_quote_s OWNER TO sofie;
...
ALTER SEQUENCE instrument_quote_hist_s OWNER TO sofie;
...
ALTER SEQUENCE counterparty_type_s OWNER TO sofie;
...
ALTER SEQUENCE counterparty_s OWNER TO sofie;
...
ALTER SEQUENCE portfolio_master_data_s OWNER TO sofie;
...
ALTER SEQUENCE position_master_data_s OWNER TO sofie;
...
ALTER SEQUENCE position_detail_s OWNER TO sofie;
...
ALTER SEQUENCE txn_status_s OWNER TO sofie;
