...
CREATE TABLE account_mapping (
    ...
    CONSTRAINT uk_account_mapping UNIQUE (mapping_key, account_slot),
    CONSTRAINT fk_am_slot FOREIGN KEY (account_slot) REFERENCES gl_account_slots(account_slot_id)
);
