...
-- Started on 2026-06-25 17:09:12
...
--
-- TOC entry 316 (class 1255 OID 37973)
...
--
-- TOC entry 317 (class 1255 OID 37974)
...
--
-- TOC entry 217 (class 1259 OID 37975)
...
--
-- TOC entry 218 (class 1259 OID 37979)
-- Name: accounting_event_status; Type: TABLE; Schema: public; Owner: sofie
--

CREATE TABLE public.accounting_event_status (
...
ALTER TABLE public.accounting_event_status OWNER TO sofie;

--
-- TOC entry 219 (class 1259 OID 37983)
-- Name: accounting_event_types; Type: TABLE; Schema: public; Owner: sofie
--

CREATE TABLE public.accounting_event_types (
...
ALTER TABLE public.accounting_event_types OWNER TO sofie;

--
-- TOC entry 220 (class 1259 OID 37987)
-- Name: accounting_events; Type: TABLE; Schema: public; Owner: sofie
--
...
CREATE TABLE public.accounting_events (
    ...
    generated_ref character varying(100),
    created_at timestamp without time zone DEFAULT now() NOT NULL,
    processed_at timestamp without time zone
);


ALTER TABLE public.accounting_events OWNER TO sofie;

--
-- TOC entry 221 (class 1259 OID 37991)
-- Name: accounting_events_s; Type: SEQUENCE; Schema: public; Owner: sofie
--

CREATE SEQUENCE public.accounting_events_s
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.accounting_events_s OWNER TO sofie;

--
-- TOC entry 222 (class 1259 OID 37992)
...
--
-- TOC entry 223 (class 1259 OID 37995)
...
--
-- TOC entry 224 (class 1259 OID 37996)
...
--
-- TOC entry 225 (class 1259 OID 37999)
...
--
-- TOC entry 226 (class 1259 OID 38000)
...
--
-- TOC entry 227 (class 1259 OID 38004)
...
--
-- TOC entry 228 (class 1259 OID 38005)
...
--
-- TOC entry 229 (class 1259 OID 38008)
-- Name: broker_instrument_rules; Type: TABLE; Schema: public; Owner: sofie
--

CREATE TABLE public.broker_instrument_rules (
    broker_rule_id integer NOT NULL,
    broker integer NOT NULL,
    master_data integer NOT NULL,
    txn_side smallint NOT NULL,
    initial_margin numeric(15,5) DEFAULT 0.0 NOT NULL,
    maintenance_margin numeric(15,5) DEFAULT 0.0 NOT NULL,
    broker_fee numeric(15,5) DEFAULT 0.0 NOT NULL,
    exchange_fee numeric(15,5) DEFAULT 0.0 NOT NULL,
    currency integer NOT NULL
);


ALTER TABLE public.broker_instrument_rules OWNER TO sofie;

--
-- TOC entry 230 (class 1259 OID 38015)
-- Name: broker_instrument_rules_s; Type: SEQUENCE; Schema: public; Owner: sofie
--

CREATE SEQUENCE public.broker_instrument_rules_s
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.broker_instrument_rules_s OWNER TO sofie;

--
-- TOC entry 231 (class 1259 OID 38016)
...
--
-- TOC entry 232 (class 1259 OID 38019)
...
--
-- TOC entry 233 (class 1259 OID 38020)
...
--
-- TOC entry 234 (class 1259 OID 38024)
...
--
-- TOC entry 235 (class 1259 OID 38025)
...
--
-- TOC entry 236 (class 1259 OID 38028)
...
--
-- TOC entry 237 (class 1259 OID 38029)
...
--
-- TOC entry 238 (class 1259 OID 38032)
...
--
-- TOC entry 239 (class 1259 OID 38033)
...
--
-- TOC entry 240 (class 1259 OID 38036)
-- Name: counterparty_role_mapping; Type: TABLE; Schema: public; Owner: sofie
--

CREATE TABLE public.counterparty_role_mapping (
...
ALTER TABLE public.counterparty_role_mapping OWNER TO sofie;

--
-- TOC entry 241 (class 1259 OID 38039)
-- Name: counterparty_role_mapping_s; Type: SEQUENCE; Schema: public; Owner: sofie
--

CREATE SEQUENCE public.counterparty_role_mapping_s
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.counterparty_role_mapping_s OWNER TO sofie;

--
-- TOC entry 242 (class 1259 OID 38040)
-- Name: counterparty_roles; Type: TABLE; Schema: public; Owner: sofie
--
...
ALTER TABLE public.counterparty_roles OWNER TO sofie;

--
-- TOC entry 243 (class 1259 OID 38043)
...
--
-- TOC entry 244 (class 1259 OID 38044)
...
--
-- TOC entry 245 (class 1259 OID 38047)
...
--
-- TOC entry 246 (class 1259 OID 38048)
...
--
-- TOC entry 247 (class 1259 OID 38054)
...
--
-- TOC entry 248 (class 1259 OID 38055)
...
--
-- TOC entry 249 (class 1259 OID 38062)
...
--
-- TOC entry 250 (class 1259 OID 38063)
...
--
-- TOC entry 251 (class 1259 OID 38068)
...
--
-- TOC entry 252 (class 1259 OID 38071)
...
--
-- TOC entry 253 (class 1259 OID 38072)
...
--
-- TOC entry 254 (class 1259 OID 38075)
...
--
-- TOC entry 255 (class 1259 OID 38076)
-- Name: event_source_types; Type: TABLE; Schema: public; Owner: sofie
--

CREATE TABLE public.event_source_types (
...
ALTER TABLE public.event_source_types OWNER TO sofie;

--
-- TOC entry 256 (class 1259 OID 38080)
...
--
-- TOC entry 257 (class 1259 OID 38084)
...
CREATE TABLE public.financial_txn (
    ...
    txn_status_pre_elab integer DEFAULT 1 NOT NULL
);
...
--
-- TOC entry 258 (class 1259 OID 38090)
-- Name: financial_txn_components; Type: TABLE; Schema: public; Owner: sofie
--

CREATE TABLE public.financial_txn_components (
...
ALTER TABLE public.financial_txn_components OWNER TO sofie;

--
-- TOC entry 259 (class 1259 OID 38094)
-- Name: financial_txn_components_s; Type: SEQUENCE; Schema: public; Owner: sofie
--

CREATE SEQUENCE public.financial_txn_components_s
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.financial_txn_components_s OWNER TO sofie;

--
-- TOC entry 260 (class 1259 OID 38095)
...
--
-- TOC entry 261 (class 1259 OID 38096)
...
--
-- TOC entry 262 (class 1259 OID 38101)
...
--
-- TOC entry 263 (class 1259 OID 38104)
...
--
-- TOC entry 264 (class 1259 OID 38105)
...
--
-- TOC entry 265 (class 1259 OID 38109)
...
--
-- TOC entry 266 (class 1259 OID 38110)
...
--
-- TOC entry 267 (class 1259 OID 38114)
...
--
-- TOC entry 268 (class 1259 OID 38117)
...
--
-- TOC entry 269 (class 1259 OID 38124)
...
--
-- TOC entry 270 (class 1259 OID 38125)
...
--
-- TOC entry 271 (class 1259 OID 38129)
...
--
-- TOC entry 272 (class 1259 OID 38130)
...
--
-- TOC entry 273 (class 1259 OID 38133)
...
--
-- TOC entry 274 (class 1259 OID 38136)
...
--
-- TOC entry 275 (class 1259 OID 38137)
...
--
-- TOC entry 276 (class 1259 OID 38138)
-- Name: instrument_valuation; Type: TABLE; Schema: public; Owner: sofie
--

CREATE TABLE public.instrument_valuation (
    instrument_valuation_id integer NOT NULL,
    master_data integer NOT NULL,
    market_price numeric(15,5) NOT NULL,
    accrued_interest numeric(15,5) DEFAULT 0 NOT NULL,
    ytm numeric(15,5) DEFAULT 0 NOT NULL,
    duration numeric(15,5) DEFAULT 0 NOT NULL,
    mod_duration numeric(15,5) DEFAULT 0 NOT NULL,
    theoretical_price numeric(15,5) DEFAULT 0 NOT NULL,
    valuation_date date DEFAULT now() NOT NULL
);


ALTER TABLE public.instrument_valuation OWNER TO sofie;

--
-- TOC entry 277 (class 1259 OID 38147)
-- Name: instrument_valuation_s; Type: SEQUENCE; Schema: public; Owner: sofie
--

CREATE SEQUENCE public.instrument_valuation_s
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.instrument_valuation_s OWNER TO sofie;

--
-- TOC entry 278 (class 1259 OID 38148)
...
--
-- TOC entry 279 (class 1259 OID 38152)
...
--
-- TOC entry 280 (class 1259 OID 38153)
-- Name: journal_entries; Type: TABLE; Schema: public; Owner: sofie
--
...
CREATE TABLE public.journal_entries (
    ...
    reversal_of integer,
    created_at timestamp without time zone DEFAULT now() NOT NULL,
    entry_status integer DEFAULT 1 NOT NULL
);


ALTER TABLE public.journal_entries OWNER TO sofie;

--
-- TOC entry 281 (class 1259 OID 38160)
-- Name: journal_entries_s; Type: SEQUENCE; Schema: public; Owner: sofie
--

CREATE SEQUENCE public.journal_entries_s
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.journal_entries_s OWNER TO sofie;

--
-- TOC entry 282 (class 1259 OID 38161)
-- Name: journal_entry_lines; Type: TABLE; Schema: public; Owner: sofie
--
...
ALTER TABLE public.journal_entry_lines OWNER TO sofie;

--
-- TOC entry 283 (class 1259 OID 38164)
-- Name: journal_entry_lines_s; Type: SEQUENCE; Schema: public; Owner: sofie
--

CREATE SEQUENCE public.journal_entry_lines_s
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.journal_entry_lines_s OWNER TO sofie;

--
-- TOC entry 284 (class 1259 OID 38165)
-- Name: journal_entry_status; Type: TABLE; Schema: public; Owner: sofie
--

CREATE TABLE public.journal_entry_status (
...
ALTER TABLE public.journal_entry_status OWNER TO sofie;

--
-- TOC entry 285 (class 1259 OID 38168)
-- Name: journal_entry_types; Type: TABLE; Schema: public; Owner: sofie
--
...
ALTER TABLE public.journal_entry_types OWNER TO sofie;

--
-- TOC entry 286 (class 1259 OID 38171)
...
--
-- TOC entry 287 (class 1259 OID 38183)
...
--
-- TOC entry 288 (class 1259 OID 38191)
...
--
-- TOC entry 289 (class 1259 OID 38192)
...
--
-- TOC entry 290 (class 1259 OID 38195)
...
--
-- TOC entry 291 (class 1259 OID 38199)
...
--
-- TOC entry 292 (class 1259 OID 38202)
...
--
-- TOC entry 293 (class 1259 OID 38203)
...
CREATE TABLE public.position_detail (
    ...
    ytm numeric(15,5) DEFAULT 0 NOT NULL,
    duration numeric(15,5) DEFAULT 0 NOT NULL,
    time_to_maturity numeric(15,5) DEFAULT 0 NOT NULL,
    mod_duration numeric(15,5) DEFAULT 0 NOT NULL,
    theoretical_price numeric(15,5) DEFAULT 0 NOT NULL,
    buy_accrual numeric(15,5) DEFAULT 0 NOT NULL,
    sell_accrual numeric(15,5) DEFAULT 0 NOT NULL,
    official_date date DEFAULT now() NOT NULL,
    last_mtm_executed timestamp without time zone DEFAULT (now() - '01:00:00'::interval)
);
...
--
-- TOC entry 294 (class 1259 OID 38215)
...
--
-- TOC entry 295 (class 1259 OID 38216)
...
--
-- TOC entry 298 (class 1259 OID 38223)
...
--
-- TOC entry 299 (class 1259 OID 38224)
-- Name: sbc_status; Type: TABLE; Schema: public; Owner: sofie
--

CREATE TABLE public.sbc_status (
...
ALTER TABLE public.sbc_status OWNER TO sofie;

--
-- TOC entry 300 (class 1259 OID 38227)
...
--
-- TOC entry 301 (class 1259 OID 38232)
...
--
-- TOC entry 302 (class 1259 OID 38236)
...
--
-- TOC entry 303 (class 1259 OID 38237)
...
--
-- TOC entry 304 (class 1259 OID 38241)
...
--
-- TOC entry 305 (class 1259 OID 38242)
-- Name: system_business_calendar; Type: TABLE; Schema: public; Owner: sofie
--

CREATE TABLE public.system_business_calendar (
...
ALTER TABLE public.system_business_calendar OWNER TO sofie;

--
-- TOC entry 306 (class 1259 OID 38247)
-- Name: txn_component_types; Type: TABLE; Schema: public; Owner: sofie
--

CREATE TABLE public.txn_component_types (
...
ALTER TABLE public.txn_component_types OWNER TO sofie;

--
-- TOC entry 307 (class 1259 OID 38250)
-- Name: txn_side; Type: TABLE; Schema: public; Owner: sofie
--

CREATE TABLE public.txn_side (
...
ALTER TABLE public.txn_side OWNER TO sofie;

--
-- TOC entry 308 (class 1259 OID 38253)
...
--
-- TOC entry 309 (class 1259 OID 38256)
...
--
-- TOC entry 310 (class 1259 OID 38257)
...
--
-- TOC entry 311 (class 1259 OID 38260)
...
--
-- TOC entry 313 (class 1259 OID 38267)
...
--
-- TOC entry 314 (class 1259 OID 38271)
...
--
-- TOC entry 315 (class 1259 OID 38272)
...
--
-- TOC entry 5388 (class 0 OID 37975)
-- Dependencies: 217
...
--
-- TOC entry 5389 (class 0 OID 37979)
-- Dependencies: 218
-- Data for Name: accounting_event_status; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.accounting_event_status (event_status_id, code, description) FROM stdin;
1	NEW	New
...
--
-- TOC entry 5390 (class 0 OID 37983)
-- Dependencies: 219
-- Data for Name: accounting_event_types; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.accounting_event_types (event_type_id, code, description) FROM stdin;
1	TRADE_EXECUTED	Trade Executed
2	TRADE_AMENDED	Trade Amended
4	MTM	Mtm
5	COUPON	Coupon
6	ACCRUAL	Accrual
7	SETTLEMENT	Settlement
8	MATURITY	Maturity
9	FX_REVALUATION	Fx Revaluation
3	TRADE_CANCELED	Trade Cancelled
\.


--
-- TOC entry 5391 (class 0 OID 37987)
-- Dependencies: 220
-- Data for Name: accounting_events; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.accounting_events (event_id, event_type, event_status, source_type, source_id, event_key, generated_by, generated_ref, created_at, processed_at) FROM stdin;
1	1	1	1	1	IT0005240350 [1] [EXECUTED]2026-06-24	58		2026-06-24 23:22:49.920692	\N
2	1	1	1	2	IT0005240350 [2] [EXECUTED]2026-06-24	58		2026-06-24 23:23:20.024407	\N
3	1	1	1	3	IT0005441883 [3] [EXECUTED]2026-06-25	26		2026-06-25 09:19:36.000944	\N
\.


--
-- TOC entry 5393 (class 0 OID 37992)
-- Dependencies: 222
...
--
-- TOC entry 5395 (class 0 OID 37996)
-- Dependencies: 224
...
--
-- TOC entry 5397 (class 0 OID 38000)
-- Dependencies: 226
...
--
-- TOC entry 5399 (class 0 OID 38005)
-- Dependencies: 228
...
--
-- TOC entry 5400 (class 0 OID 38008)
-- Dependencies: 229
-- Data for Name: broker_instrument_rules; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.broker_instrument_rules (broker_rule_id, broker, master_data, txn_side, initial_margin, maintenance_margin, broker_fee, exchange_fee, currency) FROM stdin;
1	2	61	1	240.00000	240.00000	0.50000	0.50000	2
2	2	61	2	250.00000	250.00000	1.00000	1.00000	2
\.


--
-- TOC entry 5402 (class 0 OID 38016)
-- Dependencies: 231
...
--
-- TOC entry 5404 (class 0 OID 38020)
-- Dependencies: 233
...
--
-- TOC entry 5406 (class 0 OID 38025)
-- Dependencies: 235
...
--
-- TOC entry 5408 (class 0 OID 38029)
-- Dependencies: 237
...
--
-- TOC entry 5410 (class 0 OID 38033)
-- Dependencies: 239
...
2	2	LCZ7XYGSLJUHFXXNXD88	2	CME	CME Group
3	2	549300BEI5FJA6U6QK51	2	OANDA	Oanda Smarter Trading
4	2	549300SZJ9VS8SGXAN81	4	UBS	UBS Group AG
\.


--
-- TOC entry 5411 (class 0 OID 38036)
-- Dependencies: 240
-- Data for Name: counterparty_role_mapping; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.counterparty_role_mapping (counterparty_role_mapping_id, counterparty, ctp_role) FROM stdin;
1	2	3
2	3	3
3	4	3
\.
...
--
-- TOC entry 5413 (class 0 OID 38040)
-- Dependencies: 242
-- Data for Name: counterparty_roles; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.counterparty_roles (role_id, code, description) FROM stdin;
1	CUSTOMER	Customer
2	VENDOR	Vendor
3	BROKER	Financial Broker
4	CLEARING_HOUSE	Clearing House
5	INTERNAL_ENTITY	Group companies / Affiliates
\.


--
-- TOC entry 5415 (class 0 OID 38044)
-- Dependencies: 244
...
1	NATURAL_PERSON	Individual Person
2	LEGAL_ENTITY	Corporate Entity
3	INVESTMENT_FUND	Investment Fund
4	SOVEREIGN_PUBLIC	Sovereign Government
\.


--
-- TOC entry 5417 (class 0 OID 38048)
-- Dependencies: 246
...
--
-- TOC entry 5419 (class 0 OID 38055)
-- Dependencies: 248
...
--
-- TOC entry 5421 (class 0 OID 38063)
-- Dependencies: 250
...
--
-- TOC entry 5422 (class 0 OID 38068)
-- Dependencies: 251
...
--
-- TOC entry 5424 (class 0 OID 38072)
-- Dependencies: 253
...
--
-- TOC entry 5426 (class 0 OID 38076)
-- Dependencies: 255
-- Data for Name: event_source_types; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.event_source_types (source_type_id, code, description) FROM stdin;
1	TRADE	Trade
2	INSTRUMENT	Instrument
3	POSITION_DETAIL	Position Detail
\.


--
-- TOC entry 5427 (class 0 OID 38080)
-- Dependencies: 256
...
--
-- TOC entry 5428 (class 0 OID 38084)
-- Dependencies: 257
-- Data for Name: financial_txn; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.financial_txn (id_financial_txn, counterparty, position_md, master_data, txn_status, txn_side, description, trade_date, value_date, settlement, quantity, price, ref_id, version, txn_status_pre_elab) FROM stdin;
1	1	2	58	3	1	10kb	2026-06-19	2026-06-23	2026-06-23	10000.00000	94.10000	1	2	1
2	1	1	58	3	1	10kb	2026-06-19	2026-06-23	2026-06-23	10000.00000	94.10000	2	2	1
3	1	1	26	3	1	20kb	2026-06-19	2026-06-23	2026-06-23	20000.00000	60.00000	3	2	1
\.


--
-- TOC entry 5429 (class 0 OID 38090)
-- Dependencies: 258
-- Data for Name: financial_txn_components; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.financial_txn_components (txn_component_id, financial_txn, component_type, currency, amount, description) FROM stdin;
\.


--
-- TOC entry 5432 (class 0 OID 38096)
-- Dependencies: 261
...
63	1	4	TERMESTR	TERMESTR
\.


--
-- TOC entry 5433 (class 0 OID 38101)
-- Dependencies: 262
...
--
-- TOC entry 5435 (class 0 OID 38105)
-- Dependencies: 264
...
--
-- TOC entry 5437 (class 0 OID 38110)
-- Dependencies: 266
...
--
-- TOC entry 5438 (class 0 OID 38114)
-- Dependencies: 267
...
--
-- TOC entry 5439 (class 0 OID 38117)
-- Dependencies: 268
...
26	7	100020	Petty Cash - EUR	t	1	1	1	1	2026-06-05 09:03:34.250266	2026-06-05 09:03:34.250266
51	14	240090	Currency Position Control - EUR	t	1	1	2	2	2026-06-05 09:03:34.250266	2026-06-05 09:03:34.250266
37	10	130050	FX Spot Contracts - EUR	t	1	1	1	1	2026-06-05 09:03:34.250266	2026-06-05 09:03:34.250266
...
77	14	240060	FX Settlement Payable	t	1	1	2	2	2026-06-18 18:52:21.578589	2026-06-18 18:52:21.578589
78	12	190030	FX Settlement Receivable	t	1	1	1	1	2026-06-18 18:52:21.578589	2026-06-18 18:52:21.578589
79	9	120090	Currency Position - EUR	t	1	1	1	1	2026-06-25 12:51:26.676358	2026-06-25 12:51:26.676358
55	16	400010	Realized Gain on Financial Derivatives - EUR	t	1	2	4	2	2026-06-05 09:03:34.250266	2026-06-05 09:03:34.250266
56	16	400020	Unrealized Gain on Financial Derivatives - EUR	t	1	2	4	2	2026-06-05 09:03:34.250266	2026-06-05 09:03:34.250266
85	16	400011	Realized Gain on Financial Derivatives - USD	t	2	2	4	2	2026-06-25 14:30:52.208782	2026-06-25 14:30:52.208782
86	16	400012	Realized Gain on Financial Derivatives - CHF	t	4	2	4	2	2026-06-25 14:30:52.208782	2026-06-25 14:30:52.208782
87	10	130055	FX Spot Contracts - USD	t	2	1	1	1	2026-06-25 16:43:51.439219	2026-06-25 16:43:51.439219
88	10	130056	FX Spot Contracts - CHF	t	4	1	1	1	2026-06-25 16:43:51.439219	2026-06-25 16:43:51.439219
80	9	120095	Currency Position - USD	t	2	1	1	1	2026-06-25 12:51:40.636354	2026-06-25 12:51:40.636354
81	9	120096	Currency Position - CHF	t	4	1	1	1	2026-06-25 12:51:40.636354	2026-06-25 12:51:40.636354
82	14	240095	Currency Position Control - USD	t	2	1	2	2	2026-06-25 12:51:40.636354	2026-06-25 12:51:40.636354
83	14	240096	Currency Position Control - CHF	t	4	1	2	2	2026-06-25 12:51:40.636354	2026-06-25 12:51:40.636354
\.


--
-- TOC entry 5441 (class 0 OID 38125)
-- Dependencies: 270
...
--
-- TOC entry 5443 (class 0 OID 38130)
-- Dependencies: 272
...
2	60	InvestingComProvider	EURUSD	1.13560	1.13580
1	63	InvestingComProvider	EURCHF	0.92100	0.92350
3	26	EuroNextProvider	IT0005441883	59.94000	59.95000
4	58	EuroNextProvider	IT0005240350	94.87000	94.90000
\.


--
-- TOC entry 5444 (class 0 OID 38133)
-- Dependencies: 273
...
--
-- TOC entry 5447 (class 0 OID 38138)
-- Dependencies: 276
-- Data for Name: instrument_valuation; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.instrument_valuation (instrument_valuation_id, master_data, market_price, accrued_interest, ytm, duration, mod_duration, theoretical_price, valuation_date) FROM stdin;
58	58	94.87000	0.75897	0.03279	0.00000	6.46629	94.87000	2026-06-23
26	26	59.94000	0.66603	0.04135	0.00000	23.34609	59.94000	2026-06-23
\.


--
-- TOC entry 5449 (class 0 OID 38148)
-- Dependencies: 278
...
2	USDT	United States Department of the Treasury	2
\.


--
-- TOC entry 5451 (class 0 OID 38153)
-- Dependencies: 280
-- Data for Name: journal_entries; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.journal_entries (journal_entry_id, accounting_event, entry_type, business_date, reference, description, reversal_of, created_at, entry_status) FROM stdin;
\.


--
-- TOC entry 5453 (class 0 OID 38161)
-- Dependencies: 282
-- Data for Name: journal_entry_lines; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.journal_entry_lines (journal_entry_line_id, journal_entry, line_no, gl_account, debit_amount, credit_amount, currency, description) FROM stdin;
\.


--
-- TOC entry 5455 (class 0 OID 38165)
-- Dependencies: 284
-- Data for Name: journal_entry_status; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.journal_entry_status (entry_status_id, code, description) FROM stdin;
1	UNCONSOLIDATED	Unconsolidated
2	CONSOLIDATED	Consolidated
3	ERROR	Error
\.


--
-- TOC entry 5456 (class 0 OID 38168)
-- Dependencies: 285
-- Data for Name: journal_entry_types; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.journal_entry_types (entry_type_id, code, description) FROM stdin;
1	ACCOUNTING	Official accounting entry
2	MEMO	Memorandum entry
3	REVERSAL	Reversal entry
4	ADJUSTMENT	Adjustment entry
\.


--
-- TOC entry 5457 (class 0 OID 38171)
-- Dependencies: 286
...
--
-- TOC entry 5458 (class 0 OID 38183)
-- Dependencies: 287
...
62	US912810QL52	2	2010-11-15	2040-11-15	1	1	5	3	2	100	100	4.2500000000	95.66970	100.00000	2	2	3	0.01000	US Treasury 4.25% 15/11/2040
63	EURCHF	1	2026-06-23	2026-06-23	100	1	2	2	100	100	100	0.0000000000	0.00000	0.00000	2	9	100	1.00000	\N
\.


--
-- TOC entry 5460 (class 0 OID 38192)
-- Dependencies: 289
...
--
-- TOC entry 5461 (class 0 OID 38195)
-- Dependencies: 290
...
--
-- TOC entry 5462 (class 0 OID 38199)
-- Dependencies: 291
...
2	2	USDT	United States Department of the Treasury
3	4	PTCHFO1	Default Portfolio (CHF)
\.


--
-- TOC entry 5464 (class 0 OID 38203)
-- Dependencies: 293
-- Data for Name: position_detail; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.position_detail (id_position_detail, position_md, master_data, counterparty, realized_pnl, unrealized_pnl, buy_qty, notional_value_buy, buy_fees, buy_taxes, sell_qty, notional_value_sell, sell_fees, sell_taxes, market_price, ytm, duration, time_to_maturity, mod_duration, theoretical_price, buy_accrual, sell_accrual, official_date, last_mtm_executed) FROM stdin;
1	2	58	1	0.00000	77.00000	10000.00000	9410.00000	0.00000	0.00000	0.00000	0.00000	0.00000	0.00000	94.87000	0.03279	0.00000	0.00000	6.46629	94.87000	77.22826	0.00000	2026-06-19	2026-06-25 10:31:30.989124
3	1	26	1	0.00000	-12.00000	20000.00000	12000.00000	0.00000	0.00000	0.00000	0.00000	0.00000	0.00000	59.94000	0.04135	0.00000	0.00000	23.34609	59.94000	135.54348	0.00000	2026-06-19	2026-06-25 10:31:31.006512
2	1	58	1	0.00000	77.00000	10000.00000	9410.00000	0.00000	0.00000	0.00000	0.00000	0.00000	0.00000	94.87000	0.03279	0.00000	0.00000	6.46629	94.87000	77.22826	0.00000	2026-06-19	2026-06-25 10:31:31.006512
\.


--
-- TOC entry 5466 (class 0 OID 38216)
-- Dependencies: 295
...
2	3	4	PCHF01	Default Position (CHF)
\.


--
-- TOC entry 5468 (class 0 OID 38220)
-- Dependencies: 297
...
--
-- TOC entry 5470 (class 0 OID 38224)
-- Dependencies: 299
-- Data for Name: sbc_status; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.sbc_status (sbc_status_id, code, description) FROM stdin;
1	OPEN	Open
2	CLOSING	Closing
3	CLOSED	Closed
4	LOCKED	Loked
...
--
-- TOC entry 5471 (class 0 OID 38227)
-- Dependencies: 300
...
62	US912810QL52				2	100.0000000000	2.1250000000	2011-05-15
\.


--
-- TOC entry 5472 (class 0 OID 38232)
-- Dependencies: 301
...
--
-- TOC entry 5474 (class 0 OID 38237)
-- Dependencies: 303
...
--
-- TOC entry 5476 (class 0 OID 38242)
-- Dependencies: 305
-- Data for Name: system_business_calendar; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.system_business_calendar (sbc_id, description, calendar, status, official_date, next_business_date, version, updated_at) FROM stdin;
1	SO.FI.E Buiness Calendar	1	1	2026-06-19	\N	0	2026-06-21 12:34:25.66818
\.


--
-- TOC entry 5477 (class 0 OID 38247)
-- Dependencies: 306
-- Data for Name: txn_component_types; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.txn_component_types (component_type_id, code, description) FROM stdin;
1	BROKER_FEE	Broker Transaction and Execution Fees
2	EXCHANGE_FEE	CME / Clearing House Regulatory Fees
3	INITIAL_MARGIN	Initial Margin Deposit Requirement
4	MAINTENANCE_MARGIN	Maintenance Margin Requirement
5	OPTION_PREMIUM	Option Premium Paid or Written
\.


--
-- TOC entry 5478 (class 0 OID 38250)
-- Dependencies: 307
-- Data for Name: txn_side; Type: TABLE DATA; Schema: public; Owner: sofie
--

COPY public.txn_side (id_txn_side, code, description) FROM stdin;
1	BUY	Buy
2	SELL	Sell
\.
...
--
-- TOC entry 5479 (class 0 OID 38253)
-- Dependencies: 308
...
--
-- TOC entry 5481 (class 0 OID 38257)
-- Dependencies: 310
...
--
-- TOC entry 5483 (class 0 OID 38261)
-- Dependencies: 312
...
--
-- TOC entry 5484 (class 0 OID 38267)
-- Dependencies: 313
...
-- Dependencies: 221
-- Name: accounting_events_s; Type: SEQUENCE SET; Schema: public; Owner: sofie
--

SELECT pg_catalog.setval('public.accounting_events_s', 3, true);
...
-- Dependencies: 230
-- Name: broker_instrument_rules_s; Type: SEQUENCE SET; Schema: public; Owner: sofie
--

SELECT pg_catalog.setval('public.broker_instrument_rules_s', 2, true);
...
-- Dependencies: 241
-- Name: counterparty_role_mapping_s; Type: SEQUENCE SET; Schema: public; Owner: sofie
--

SELECT pg_catalog.setval('public.counterparty_role_mapping_s', 3, true);
...
SELECT pg_catalog.setval('public.counterparty_s', 4, true);
...
-- Dependencies: 259
-- Name: financial_txn_components_s; Type: SEQUENCE SET; Schema: public; Owner: sofie
--

SELECT pg_catalog.setval('public.financial_txn_components_s', 1, true);
...
SELECT pg_catalog.setval('public.financial_txn_s', 3, true);
...
SELECT pg_catalog.setval('public.gl_accounts_s', 88, true);
...
SELECT pg_catalog.setval('public.instrument_quote_s', 4, true);


--
-- TOC entry 5516 (class 0 OID 0)
-- Dependencies: 277
-- Name: instrument_valuation_s; Type: SEQUENCE SET; Schema: public; Owner: sofie
--

SELECT pg_catalog.setval('public.instrument_valuation_s', 1, false);
...
SELECT pg_catalog.setval('public.issuer_s', 2, true);


--
-- TOC entry 5518 (class 0 OID 0)
-- Dependencies: 281
-- Name: journal_entries_s; Type: SEQUENCE SET; Schema: public; Owner: sofie
--

SELECT pg_catalog.setval('public.journal_entries_s', 1, false);


--
-- TOC entry 5519 (class 0 OID 0)
-- Dependencies: 283
-- Name: journal_entry_lines_s; Type: SEQUENCE SET; Schema: public; Owner: sofie
--

SELECT pg_catalog.setval('public.journal_entry_lines_s', 1, false);
...
SELECT pg_catalog.setval('public.master_data_s', 63, true);
...
SELECT pg_catalog.setval('public.position_detail_s', 3, true);
...
--
-- TOC entry 4993 (class 2606 OID 38274)
...
--
-- TOC entry 4995 (class 2606 OID 38276)
-- Name: accounting_event_status accounting_event_status_pkey; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.accounting_event_status
    ADD CONSTRAINT accounting_event_status_pkey PRIMARY KEY (event_status_id);


--
-- TOC entry 4998 (class 2606 OID 38278)
-- Name: accounting_event_types accounting_event_types_pkey; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.accounting_event_types
    ADD CONSTRAINT accounting_event_types_pkey PRIMARY KEY (event_type_id);


--
-- TOC entry 5001 (class 2606 OID 38280)
-- Name: accounting_events accounting_events_pkey; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.accounting_events
    ADD CONSTRAINT accounting_events_pkey PRIMARY KEY (event_id);


--
-- TOC entry 5007 (class 2606 OID 38282)
...
--
-- TOC entry 5010 (class 2606 OID 38284)
...
--
-- TOC entry 5013 (class 2606 OID 38286)
...
--
-- TOC entry 5016 (class 2606 OID 38288)
...
--
-- TOC entry 5018 (class 2606 OID 38290)
-- Name: broker_instrument_rules broker_instrument_rules_pkey; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.broker_instrument_rules
    ADD CONSTRAINT broker_instrument_rules_pkey PRIMARY KEY (broker_rule_id);


--
-- TOC entry 5022 (class 2606 OID 38292)
...
--
-- TOC entry 5025 (class 2606 OID 38294)
...
--
-- TOC entry 5028 (class 2606 OID 38296)
...
--
-- TOC entry 5031 (class 2606 OID 38298)
...
--
-- TOC entry 5034 (class 2606 OID 38300)
...
--
-- TOC entry 5037 (class 2606 OID 38302)
-- Name: counterparty_role_mapping counterparty_role_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.counterparty_role_mapping
    ADD CONSTRAINT counterparty_role_mapping_pkey PRIMARY KEY (counterparty_role_mapping_id);


--
-- TOC entry 5040 (class 2606 OID 38304)
-- Name: counterparty_roles counterparty_roles_code_key; Type: CONSTRAINT; Schema: public; Owner: sofie
--
...
--
-- TOC entry 5042 (class 2606 OID 38306)
-- Name: counterparty_roles counterparty_roles_pkey; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.counterparty_roles
    ADD CONSTRAINT counterparty_roles_pkey PRIMARY KEY (role_id);


--
-- TOC entry 5044 (class 2606 OID 38308)
...
--
-- TOC entry 5049 (class 2606 OID 38310)
...
--
-- TOC entry 5052 (class 2606 OID 38312)
...
--
-- TOC entry 5056 (class 2606 OID 38314)
...
--
-- TOC entry 5059 (class 2606 OID 38316)
...
--
-- TOC entry 5062 (class 2606 OID 38318)
...
--
-- TOC entry 5065 (class 2606 OID 38320)
-- Name: event_source_types event_source_types_pkey; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.event_source_types
    ADD CONSTRAINT event_source_types_pkey PRIMARY KEY (source_type_id);


--
-- TOC entry 5068 (class 2606 OID 38322)
...
--
-- TOC entry 5072 (class 2606 OID 38324)
-- Name: financial_txn_components financial_txn_components_pkey; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.financial_txn_components
    ADD CONSTRAINT financial_txn_components_pkey PRIMARY KEY (txn_component_id);


--
-- TOC entry 5070 (class 2606 OID 38326)
...
--
-- TOC entry 5074 (class 2606 OID 38328)
...
--
-- TOC entry 5077 (class 2606 OID 38330)
...
--
-- TOC entry 5080 (class 2606 OID 38332)
...
--
-- TOC entry 5083 (class 2606 OID 38334)
...
--
-- TOC entry 5086 (class 2606 OID 38336)
...
--
-- TOC entry 5088 (class 2606 OID 38338)
...
--
-- TOC entry 5090 (class 2606 OID 38340)
...
--
-- TOC entry 5093 (class 2606 OID 38342)
...
--
-- TOC entry 5020 (class 2606 OID 38344)
-- Name: broker_instrument_rules idx_broker_inst_side; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.broker_instrument_rules
    ADD CONSTRAINT idx_broker_inst_side UNIQUE (broker, master_data, txn_side);


--
-- TOC entry 5099 (class 2606 OID 38346)
...
--
-- TOC entry 5096 (class 2606 OID 38348)
...
--
-- TOC entry 5101 (class 2606 OID 38350)
-- Name: instrument_valuation instrument_valuation_pkey; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.instrument_valuation
    ADD CONSTRAINT instrument_valuation_pkey PRIMARY KEY (instrument_valuation_id);


--
-- TOC entry 5103 (class 2606 OID 38352)
...
--
-- TOC entry 5105 (class 2606 OID 38354)
-- Name: journal_entries journal_entries_pkey; Type: CONSTRAINT; Schema: public; Owner: sofie
--
...
--
-- TOC entry 5107 (class 2606 OID 38356)
-- Name: journal_entry_lines journal_entry_lines_pkey; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.journal_entry_lines
    ADD CONSTRAINT journal_entry_lines_pkey PRIMARY KEY (journal_entry_line_id);


--
-- TOC entry 5109 (class 2606 OID 38358)
-- Name: journal_entry_status journal_entry_status_pkey; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.journal_entry_status
    ADD CONSTRAINT journal_entry_status_pkey PRIMARY KEY (entry_status_id);


--
-- TOC entry 5111 (class 2606 OID 38360)
-- Name: journal_entry_types journal_entry_types_pkey; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.journal_entry_types
    ADD CONSTRAINT journal_entry_types_pkey PRIMARY KEY (entry_type_id);


--
-- TOC entry 5113 (class 2606 OID 38362)
...
--
-- TOC entry 5116 (class 2606 OID 38364)
...
--
-- TOC entry 5118 (class 2606 OID 38366)
...
--
-- TOC entry 5120 (class 2606 OID 38368)
...
--
-- TOC entry 5123 (class 2606 OID 38370)
...
--
-- TOC entry 5126 (class 2606 OID 38372)
...
--
-- TOC entry 5129 (class 2606 OID 38374)
...
--
-- TOC entry 5132 (class 2606 OID 38376)
...
--
-- TOC entry 5134 (class 2606 OID 38378)
-- Name: sbc_status sbc_status_code_key; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.sbc_status
    ADD CONSTRAINT sbc_status_code_key UNIQUE (code);


--
-- TOC entry 5136 (class 2606 OID 38380)
-- Name: sbc_status sbc_status_pkey; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.sbc_status
    ADD CONSTRAINT sbc_status_pkey PRIMARY KEY (sbc_status_id);


--
-- TOC entry 5139 (class 2606 OID 38382)
...
--
-- TOC entry 5142 (class 2606 OID 38384)
...
--
-- TOC entry 5145 (class 2606 OID 38386)
...
--
-- TOC entry 5147 (class 2606 OID 38388)
-- Name: system_business_calendar system_business_calendar_calendar_key; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.system_business_calendar
    ADD CONSTRAINT system_business_calendar_calendar_key UNIQUE (calendar);


--
-- TOC entry 5149 (class 2606 OID 38390)
-- Name: system_business_calendar system_business_calendar_pkey; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.system_business_calendar
    ADD CONSTRAINT system_business_calendar_pkey PRIMARY KEY (sbc_id);


--
-- TOC entry 5151 (class 2606 OID 38392)
-- Name: txn_component_types txn_component_types_code_key; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.txn_component_types
    ADD CONSTRAINT txn_component_types_code_key UNIQUE (code);


--
-- TOC entry 5153 (class 2606 OID 38394)
-- Name: txn_component_types txn_component_types_pkey; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.txn_component_types
    ADD CONSTRAINT txn_component_types_pkey PRIMARY KEY (component_type_id);


--
-- TOC entry 5156 (class 2606 OID 38396)
-- Name: txn_side txn_side_pkey; Type: CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.txn_side
    ADD CONSTRAINT txn_side_pkey PRIMARY KEY (id_txn_side);


--
-- TOC entry 5159 (class 2606 OID 38398)
...
--
-- TOC entry 5162 (class 2606 OID 38400)
...
--
-- TOC entry 5168 (class 2606 OID 38402)
...
--
-- TOC entry 5165 (class 2606 OID 38404)
...
--
-- TOC entry 5046 (class 1259 OID 38405)
...
--
-- TOC entry 5047 (class 1259 OID 38406)
...
--
-- TOC entry 5091 (class 1259 OID 38407)
...
--
-- TOC entry 5008 (class 1259 OID 38408)
...
--
-- TOC entry 5011 (class 1259 OID 38409)
...
--
-- TOC entry 5014 (class 1259 OID 38410)
...
--
-- TOC entry 5023 (class 1259 OID 38411)
...
--
-- TOC entry 5032 (class 1259 OID 38412)
...
--
-- TOC entry 5035 (class 1259 OID 38413)
...
--
-- TOC entry 5045 (class 1259 OID 38414)
...
--
-- TOC entry 5050 (class 1259 OID 38415)
...
--
-- TOC entry 5038 (class 1259 OID 38416)
-- Name: idx_ctp_role; Type: INDEX; Schema: public; Owner: sofie
--

CREATE UNIQUE INDEX idx_ctp_role ON public.counterparty_role_mapping USING btree (counterparty, ctp_role);


--
-- TOC entry 5053 (class 1259 OID 38417)
...
--
-- TOC entry 5057 (class 1259 OID 38418)
...
--
-- TOC entry 5060 (class 1259 OID 38419)
...
--
-- TOC entry 5063 (class 1259 OID 38420)
...
--
-- TOC entry 5002 (class 1259 OID 38421)
-- Name: idx_event_key; Type: INDEX; Schema: public; Owner: sofie
--

CREATE UNIQUE INDEX idx_event_key ON public.accounting_events USING btree (event_key);


--
-- TOC entry 4996 (class 1259 OID 38422)
-- Name: idx_event_status_code; Type: INDEX; Schema: public; Owner: sofie
--

CREATE UNIQUE INDEX idx_event_status_code ON public.accounting_event_status USING btree (code);


--
-- TOC entry 5003 (class 1259 OID 38423)
-- Name: idx_event_status_created; Type: INDEX; Schema: public; Owner: sofie
--

CREATE INDEX idx_event_status_created ON public.accounting_events USING btree (event_status, created_at);


--
-- TOC entry 5004 (class 1259 OID 38424)
-- Name: idx_event_status_type; Type: INDEX; Schema: public; Owner: sofie
--

CREATE INDEX idx_event_status_type ON public.accounting_events USING btree (event_status, event_type);


--
-- TOC entry 4999 (class 1259 OID 38425)
-- Name: idx_event_types_code; Type: INDEX; Schema: public; Owner: sofie
--

CREATE UNIQUE INDEX idx_event_types_code ON public.accounting_event_types USING btree (code);


--
-- TOC entry 5075 (class 1259 OID 38426)
...
--
-- TOC entry 5078 (class 1259 OID 38427)
...
--
-- TOC entry 5081 (class 1259 OID 38428)
...
--
-- TOC entry 5084 (class 1259 OID 38429)
...
--
-- TOC entry 5094 (class 1259 OID 38430)
...
--
-- TOC entry 5097 (class 1259 OID 38431)
...
--
-- TOC entry 5054 (class 1259 OID 38432)
...
--
-- TOC entry 5114 (class 1259 OID 38433)
...
--
-- TOC entry 5026 (class 1259 OID 38434)
...
--
-- TOC entry 5029 (class 1259 OID 38435)
...
--
-- TOC entry 5121 (class 1259 OID 38436)
...
--
-- TOC entry 5127 (class 1259 OID 38437)
...
--
-- TOC entry 5124 (class 1259 OID 38438)
...
--
-- TOC entry 5130 (class 1259 OID 38439)
...
--
-- TOC entry 5137 (class 1259 OID 38440)
...
--
-- TOC entry 5140 (class 1259 OID 38441)
...
--
-- TOC entry 5005 (class 1259 OID 38442)
-- Name: idx_source; Type: INDEX; Schema: public; Owner: sofie
--

CREATE INDEX idx_source ON public.accounting_events USING btree (source_type, source_id);


--
-- TOC entry 5066 (class 1259 OID 38443)
-- Name: idx_source_code; Type: INDEX; Schema: public; Owner: sofie
--

CREATE UNIQUE INDEX idx_source_code ON public.event_source_types USING btree (code);


--
-- TOC entry 5143 (class 1259 OID 38444)
...
--
-- TOC entry 5154 (class 1259 OID 38445)
-- Name: idx_txn_side_code; Type: INDEX; Schema: public; Owner: sofie
--

CREATE UNIQUE INDEX idx_txn_side_code ON public.txn_side USING btree (code);


--
-- TOC entry 5157 (class 1259 OID 38446)
...
--
-- TOC entry 5160 (class 1259 OID 38447)
...
--
-- TOC entry 5163 (class 1259 OID 38448)
...
--
-- TOC entry 5166 (class 1259 OID 38449)
...
--
-- TOC entry 5242 (class 2620 OID 38450)
...
--
-- TOC entry 5218 (class 2606 OID 38451)
...
--
-- TOC entry 5219 (class 2606 OID 38456)
...
--
-- TOC entry 5220 (class 2606 OID 38461)
...
--
-- TOC entry 5221 (class 2606 OID 38466)
...
--
-- TOC entry 5200 (class 2606 OID 38471)
...
--
-- TOC entry 5186 (class 2606 OID 38476)
...
--
-- TOC entry 5196 (class 2606 OID 38481)
...
--
-- TOC entry 5182 (class 2606 OID 38486)
...
--
-- TOC entry 5184 (class 2606 OID 38491)
...
--
-- TOC entry 5205 (class 2606 OID 38496)
...
--
-- TOC entry 5236 (class 2606 OID 38501)
-- Name: system_business_calendar fk_calendar; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--
...
--
-- TOC entry 5238 (class 2606 OID 38506)
...
--
-- TOC entry 5187 (class 2606 OID 38511)
...
--
-- TOC entry 5197 (class 2606 OID 38516)
...
--
-- TOC entry 5193 (class 2606 OID 38521)
-- Name: financial_txn_components fk_component_type; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.financial_txn_components
    ADD CONSTRAINT fk_component_type FOREIGN KEY (component_type) REFERENCES public.txn_component_types(component_type_id);


--
-- TOC entry 5189 (class 2606 OID 38526)
...
--
-- TOC entry 5230 (class 2606 OID 38531)
...
--
-- TOC entry 5178 (class 2606 OID 38536)
...
--
-- TOC entry 5210 (class 2606 OID 38541)
...
--
-- TOC entry 5179 (class 2606 OID 38546)
...
--
-- TOC entry 5183 (class 2606 OID 38551)
...
--
-- TOC entry 5194 (class 2606 OID 38556)
-- Name: financial_txn_components fk_currency; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--
...
--
-- TOC entry 5201 (class 2606 OID 38561)
...
--
-- TOC entry 5222 (class 2606 OID 38566)
...
--
-- TOC entry 5229 (class 2606 OID 38571)
...
--
-- TOC entry 5239 (class 2606 OID 38581)
...
--
-- TOC entry 5185 (class 2606 OID 38586)
...
--
-- TOC entry 5223 (class 2606 OID 38591)
...
--
-- TOC entry 5240 (class 2606 OID 38596)
...
--
-- TOC entry 5169 (class 2606 OID 38601)
-- Name: accounting_events fk_event_status; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.accounting_events
    ADD CONSTRAINT fk_event_status FOREIGN KEY (event_status) REFERENCES public.accounting_event_status(event_status_id);


--
-- TOC entry 5170 (class 2606 OID 38606)
-- Name: accounting_events fk_event_type; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.accounting_events
    ADD CONSTRAINT fk_event_type FOREIGN KEY (event_type) REFERENCES public.accounting_event_types(event_type_id);


--
-- TOC entry 5195 (class 2606 OID 38611)
-- Name: financial_txn_components fk_financial_txn; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.financial_txn_components
    ADD CONSTRAINT fk_financial_txn FOREIGN KEY (financial_txn) REFERENCES public.financial_txn(id_financial_txn) ON DELETE CASCADE;


--
-- TOC entry 5224 (class 2606 OID 38616)
...
--
-- TOC entry 5225 (class 2606 OID 38621)
...
--
-- TOC entry 5207 (class 2606 OID 38626)
...
--
-- TOC entry 5235 (class 2606 OID 38631)
...
--
-- TOC entry 5211 (class 2606 OID 38636)
-- Name: journal_entries fk_je_event; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.journal_entries
    ADD CONSTRAINT fk_je_event FOREIGN KEY (accounting_event) REFERENCES public.accounting_events(event_id);


--
-- TOC entry 5212 (class 2606 OID 38641)
-- Name: journal_entries fk_je_reversal; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.journal_entries
    ADD CONSTRAINT fk_je_reversal FOREIGN KEY (reversal_of) REFERENCES public.journal_entries(journal_entry_id);


--
-- TOC entry 5213 (class 2606 OID 38646)
-- Name: journal_entries fk_je_status; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.journal_entries
    ADD CONSTRAINT fk_je_status FOREIGN KEY (entry_status) REFERENCES public.journal_entry_status(entry_status_id);


--
-- TOC entry 5214 (class 2606 OID 38651)
-- Name: journal_entries fk_je_type; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.journal_entries
    ADD CONSTRAINT fk_je_type FOREIGN KEY (entry_type) REFERENCES public.journal_entry_types(entry_type_id);


--
-- TOC entry 5215 (class 2606 OID 38656)
-- Name: journal_entry_lines fk_jel_account; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.journal_entry_lines
    ADD CONSTRAINT fk_jel_account FOREIGN KEY (gl_account) REFERENCES public.gl_accounts(account_id);


--
-- TOC entry 5216 (class 2606 OID 38661)
-- Name: journal_entry_lines fk_jel_currency; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.journal_entry_lines
    ADD CONSTRAINT fk_jel_currency FOREIGN KEY (currency) REFERENCES public.currency(id_currency);


--
-- TOC entry 5217 (class 2606 OID 38666)
-- Name: journal_entry_lines fk_jel_entry; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.journal_entry_lines
    ADD CONSTRAINT fk_jel_entry FOREIGN KEY (journal_entry) REFERENCES public.journal_entries(journal_entry_id);


--
-- TOC entry 5180 (class 2606 OID 38671)
-- Name: counterparty_role_mapping fk_mapping_counterparty; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.counterparty_role_mapping
    ADD CONSTRAINT fk_mapping_counterparty FOREIGN KEY (counterparty) REFERENCES public.counterparty(id_counterparty) ON DELETE CASCADE;


--
-- TOC entry 5181 (class 2606 OID 38676)
-- Name: counterparty_role_mapping fk_mapping_role; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.counterparty_role_mapping
    ADD CONSTRAINT fk_mapping_role FOREIGN KEY (ctp_role) REFERENCES public.counterparty_roles(role_id);


--
-- TOC entry 5176 (class 2606 OID 38681)
...
--
-- TOC entry 5177 (class 2606 OID 38686)
...
--
-- TOC entry 5188 (class 2606 OID 38691)
...
--
-- TOC entry 5190 (class 2606 OID 38696)
...
--
-- TOC entry 5206 (class 2606 OID 38701)
...
--
-- TOC entry 5208 (class 2606 OID 38706)
...
--
-- TOC entry 5209 (class 2606 OID 38711)
-- Name: instrument_valuation fk_master_data; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--
...
--
-- TOC entry 5231 (class 2606 OID 38716)
...
--
-- TOC entry 5202 (class 2606 OID 38721)
...
--
-- TOC entry 5203 (class 2606 OID 38726)
...
--
-- TOC entry 5234 (class 2606 OID 38731)
...
--
-- TOC entry 5191 (class 2606 OID 38736)
...
--
-- TOC entry 5232 (class 2606 OID 38741)
...
--
-- TOC entry 5226 (class 2606 OID 38746)
...
--
-- TOC entry 5173 (class 2606 OID 38751)
-- Name: broker_instrument_rules fk_rule_broker; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.broker_instrument_rules
    ADD CONSTRAINT fk_rule_broker FOREIGN KEY (broker) REFERENCES public.counterparty(id_counterparty);


--
-- TOC entry 5174 (class 2606 OID 38756)
-- Name: broker_instrument_rules fk_rule_currency; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.broker_instrument_rules
    ADD CONSTRAINT fk_rule_currency FOREIGN KEY (currency) REFERENCES public.currency(id_currency);


--
-- TOC entry 5175 (class 2606 OID 38761)
-- Name: broker_instrument_rules fk_rule_instrument; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.broker_instrument_rules
    ADD CONSTRAINT fk_rule_instrument FOREIGN KEY (master_data) REFERENCES public.master_data(id_master_data);


--
-- TOC entry 5198 (class 2606 OID 38766)
...
--
-- TOC entry 5171 (class 2606 OID 38771)
-- Name: accounting_events fk_source_type; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.accounting_events
    ADD CONSTRAINT fk_source_type FOREIGN KEY (source_type) REFERENCES public.event_source_types(source_type_id);


--
-- TOC entry 5204 (class 2606 OID 38776)
...
--
-- TOC entry 5237 (class 2606 OID 38781)
-- Name: system_business_calendar fk_status; Type: FK CONSTRAINT; Schema: public; Owner: sofie
--

ALTER TABLE ONLY public.system_business_calendar
    ADD CONSTRAINT fk_status FOREIGN KEY (status) REFERENCES public.sbc_status(sbc_status_id);


--
-- TOC entry 5172 (class 2606 OID 38786)
...
--
-- TOC entry 5192 (class 2606 OID 38791)
...
--
-- TOC entry 5227 (class 2606 OID 38796)
...
--
-- TOC entry 5199 (class 2606 OID 38801)
...
--
-- TOC entry 5228 (class 2606 OID 38806)
...
--
-- TOC entry 5241 (class 2606 OID 38811)
...
-- Completed on 2026-06-25 17:09:12
