...
public class BondForwardCalculator {
    ...
    public org.softcaster.easy_pricer_mds_core.dto.ForwardPricingResponse bondFwdValuation(org.softcaster.easy_pricer_mds_core.dto.ForwardPricingRequest request) {
        ...
        org.softcaster.easy_pricer_mds_core.dto.ForwardPricingResponse response = null;
        if (output != null) {
    ...
    public CTDData getCTD(org.softcaster.easy_pricer_mds_core.dto.ForwardPricingRequest request) {
